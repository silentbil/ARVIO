 ...
 **/
// Rhino JS engine not bundled in arvio — plugins that call getRhinoContext() will fail gracefully.
suspend fun getRhinoContext(): Any {
    throw UnsupportedOperationException("Rhino not available in arvio")
}
